...
public class C01_MavenIlkTest {
     ...
     */
        ...
        System.out.println(sonucYazisi.getText()); // 1-16 of 248 results for "Samsung headphones"
        String [] sonucAdeti = driver.findElement
                        (By.xpath("(//*[@class='a-section a-spacing-small a-spacing-top-small'])[1]")).getText()
                .split(" ");
        System.out.println(sonucAdeti[2]);
        // 248
