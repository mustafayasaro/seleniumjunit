...
public class C03_WebTables02 extends TestCaseBeforeClassAfterClass {
    // bir onceki class daki adrese gidelim
    // Login methodunu kullanrak sayfaya giris yapalim
    // input olarak erilen satir sayisi ve sutun sayisina sahip cell deki texti yazdiralim
    //Phone no basligindaki tum nummaralari yazdirin

    int satir = 3;
    int sutun = 4;
    // bu satir ve sutunun kesisimini veren kodu yaziniz
